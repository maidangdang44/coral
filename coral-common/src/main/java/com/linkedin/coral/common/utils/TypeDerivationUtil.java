...
public class TypeDerivationUtil {
  ...
  public RelDataType getRelDataType(SqlNode sqlNode) {
    ...
    for (SqlSelect topSqlSelectNode : topSelectNodes) {
      final SqlSelect dummySqlSelect =
          new SqlSelect(topSqlSelectNode.getParserPosition(), null, SqlNodeList.of(sqlNode), topSqlSelectNode.getFrom(),
              topSqlSelectNode.getWhere(), topSqlSelectNode.getGroup(), topSqlSelectNode.getHaving(),
              topSqlSelectNode.getWindowList(), topSqlSelectNode.getQualify(), topSqlSelectNode.getOrderList(),
    ...
    try {
      final SqlSelect dummySqlSelect = new SqlSelect(topSelectNodes.get(0).getParserPosition(), null,
          SqlNodeList.of(sqlNode), topSelectNodes.get(0), null, null, null, null, null, null, null, null, null);
      sqlValidator.validate(dummySqlSelect);
